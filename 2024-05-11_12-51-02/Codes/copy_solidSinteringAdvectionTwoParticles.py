...
while timeCurrent < timeSimulation:
    ...
    # 定义源文件夹和目标文件夹
    source_folder = results_directory
    target_folder_c = results_directory + "/c"
    target_folder_eta = results_directory + "/eta"
    target_folder_v = results_directory + "/v"
    target_folder_stress = results_directory + "/stress"
    ...
    def move_and_rename_files(source_folder, target_folder_c, target_folder_eta, target_folder_v, target_folder_stress):
        # 遍历源文件夹中的文件
        for filename in os.listdir(source_folder):
            ...
            if filename.endswith(".vtu"):
                ...
                # 构建新文件名
                new_filename = f"{os.path.basename(target_folder)}_{num_files}.vtu"
    ...
    move_and_rename_files(source_folder, target_folder_c, target_folder_eta, target_folder_v, target_folder_stress)
