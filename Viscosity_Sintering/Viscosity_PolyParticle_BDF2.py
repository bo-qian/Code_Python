...
shutil.copy("input_polyparticle_viscosity_BDF2.txt", os.path.join(Input_directory, "input_polyparticle_viscosity_BDF2.txt"))
...
try:
    ...
    gbdf2_mu_WeakForm = mu_trial * mu_test * dx - pde.kc * dot(grad(c_mid), grad(mu_test)) * dx - (pde.fmu(c_prev) + pde.c_stabilizer * (c_trial - c_prev)) * mu_test * dx
