...
# Read the input file ****************************************************************************************
parameters_input = read_input_file("input_MultiParticle_reboot.txt")
...
shutil.copy("input_MultiParticle_reboot.txt", os.path.join(Input_directory, "input_MultiParticle_reboot.txt"))
